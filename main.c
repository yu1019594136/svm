...
void para_config()
{
    ...
    /* 手动配置 */
    Svm_all_filepath.train_data_filepath = "/home/zhouyu/UCI_database/test/2_bainianwanjiu_4features.txt.train";//"C:\\UCI_database\\Letter Recognition Data Set\\ABC\\ABC.txt.train"训练文件不能为NULL，
    Svm_all_filepath.test_data_filepath = "/home/zhouyu/UCI_database/test/2_bainianwanjiu_4features.txt.test";//NULL  "C:\\UCI_database\\Letter Recognition Data Set\\ABC\\ABC.txt.test"   如果没有测试文件，此处给NULL
    /*
     * 1_luzhoulaojiao
     * 2_bainianwanjiu
     * 3_daohuaxiang
    ...
    /* 配置训练参数 */
    Para_svm_train.svm_train_parameter.svm_type = ONE_CLASS;//C_SVC, NU_SVC, , EPSILON_SVR, NU_SVR,选择一个参数
    ...
    Para_svm_train.svm_train_parameter.gamma = 0.004645;//0.1;//0代表默认
    Para_svm_train.svm_train_parameter.coef0 = 0;
    Para_svm_train.svm_train_parameter.nu = 0.000001;//
    ...
    Para_grid_search.d1_step = 0.1;
    Para_grid_search.d2_begin = -10;//注意nu参数取值范围（0,1）开区间
    Para_grid_search.d2_end = -0.01;
    Para_grid_search.d2_step = 0.01;//1;
    Para_grid_search.v_fold = 3;
